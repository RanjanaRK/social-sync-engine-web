...
const PostDetail = ({ post }: Props) => {
  return (
    <article className="overflow-hidden rounded-3xl bg-[#151116] shadow-[0_20px_70px_rgba(0,0,0,0.28)] ring-1 ring-white/4.5">
      {/* Header */}
      ...
      <div className="flex items-center justify-between px-5 py-5 sm:px-6">
        ...
        <button
          type="button"
          className="flex h-9 w-9 items-center justify-center rounded-full text-[#756B72] transition-all duration-200 hover:bg-white/4 hover:text-[#C8BDC3]"
      ...
      {post.postImage?.length > 0 && (
        <div className="overflow-hidden bg-[#0F0D10]">
          <img
            ...
            className="block max-h-175 w-full object-cover transition-transform duration-500 hover:scale-[1.01]"
          />
        </div>
      )}
