...
const LogoutButton = () => {
  ...
  return (
    <button
      type="button"
      onClick={handleSubmit}
      className="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-[#A69DA3] transition-all duration-200 hover:bg-red-500/10 hover:text-red-400"
    >
      <LogOut
        size={18}
        strokeWidth={1.8}
